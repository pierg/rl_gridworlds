...
RUN echo "deb-src http://archive.ubuntu.com/ubuntu/ xenial-backports main restricted" >> /etc/apt/sources.list
RUN echo "deb-src http://ppa.launchpad.net/jonathonf/python-3.6/ubuntu xenial main" >> /etc/apt/sources.list.d/jonathonf-ubuntu-python-3_6-xenial.list
